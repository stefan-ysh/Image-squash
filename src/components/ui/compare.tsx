...
export const Compare = ({
  ...
  const startAutoplay = useCallback(() => {
    ...
    const startValue = initialSliderPercentage;
    const endValue = 100 - initialSliderPercentage;
    ...
    const animate = () => {
      ...
      const currentValue =
        startValue + (endValue - startValue) * pingPongProgress;
  ...
  return (
    ...
    >
      <AnimatePresence initial={false}>
        <motion.div
          className="h-full w-px absolute top-0 m-auto z-30 bg-gradient-to-b from-transparent from-[5%] via-violet-500 to-transparent to-[95%]"
          style={{
            left: `${sliderXPercent}%`,
            top: "0",
            zIndex: 40,
          ...
          {firstImage ? (
            ...
            >
              <img
                ...
                src={firstImage}
                className={cn(
                  "absolute inset-0 z-20 rounded-2xl flex-shrink-0 w-full h-full select-none object-contain",
                  firstImageClassName
                )}
                draggable={false}
              />
